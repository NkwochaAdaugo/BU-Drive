...
<header class="header">
    ...
    <div class="container">
        <h2> 2nd Semester, <?php echo ''.$level.''; ?></h2>
        <?php
        
        $getAdminResources = "SELECT * FROM resources WHERE department = '$course' AND semester = '2nd Semester' AND level = '$level' ORDER BY courseName";
