...
<body>
    ...
    <div class="container">
        ...
        <div class="courses">
            ...
            <div class="courses-button"><a href="MyCourses1stSemester.php"> View Courses </a></div>
        </div>
        <div class="courses">
            <div><h3> 2nd Semester </h3></div>
            <div class="courses-button"><a href="MyCourses2ndSemester.php"> View Courses </a></div>
        </div>
        </div>
