...
<body>
    ...
    <div class="container">
        ...
        <div class="courses">
            ...
            <div class="courses-button"><a href="Resources1stSemester.php?department=<?php echo urlencode($department); ?>&level=<?php echo urlencode($level); ?>&semester=<?php echo urlencode('1st Semester'); ?>"> View Courses </a></div>
        </div>
        <div class="courses">
            <div><h3> 2nd Semester </h3></div>
            <div class="courses-button"><a href="Resources2ndSemester.php?department=<?php echo urlencode($department); ?>&level=<?php echo urlencode($level); ?>&semester=<?php echo urlencode('2nd Semester'); ?>"> View Courses </a></div>
        </div>
        </div>
